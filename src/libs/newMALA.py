...
class MALA(ProposalBase):
    ...
    def body(
        ...
        this_d_log_hessian = jnp.dot(inv_hessian, this_d_log)
        # p = 0.5 * jnp.dot(dt2, this_d_log_hessian)
        # print(f"p shape: {p.shape}")
        proposal_mean = this_position + 0.5 * this_d_log_hessian
        ...
        # return (this_position, dt, data), (proposal, this_log_prob, this_d_log_hessian)  # 修改后能跑的
